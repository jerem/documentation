...
To specify what unit the product is inventoried in, update the second field of the
:guilabel:`Sales Price` or :guilabel:`Cost` fields.
...
update the :guilabel:`Packagings` field in the :guilabel:`Upsell & Cross-Sell` section of the
:guilabel:`Sales` tab of the product.
